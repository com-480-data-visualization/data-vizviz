...
- Dataset on the number of commuters per canton (2010-2023). Check [here](../datasets/xlsx/Commuters_per_canton.xlsx).
- Dataset on commuters' means of transport (1990 + 2000 + 2010-2023).. Check [here](../datasets/xlsx/Commuters_means_of_transport.xlsx).
- Dataset on commuters' travel distance and time (1990 + 2000 + 2010-2023). Check [here](../datasets/xlsx/Commuters_travel_time_distance.xlsx).
...
- Dataset on the proportion of commuters and their types of journeys (2018-2023). Check [here](../datasets/xlsx/Commuters_overview.xlsx).
- Dataset on commuters by municipality of residence and municipality of place of work (2010 + 2014 + 2018). Check [here](../datasets/xlsx/Commuters_communes.xlsx).
